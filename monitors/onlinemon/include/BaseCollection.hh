 ...
 *  This class is inherited by:
 \li \class CorrelationCollection CorrelationCollection.hh
 "CorrelationCollection.hh"
 \li \class EUDAQMonitorCollection EUDAQMonitorCollection.hh
 "EUDAQMonitorCollection.hh"
 \li \class HitmapCollection HitmapCollection.hh "HitmapCollection.hh"
 \li \class MonitorPerformanceCollection MonitorPerformanceCollection.hh
 "MonitorPerformanceCollection.hh"

 It contains the parameters:
 \li @param _reduce
 \li @param _mon This is the online monitor. It is from the class \class
 RootMonitor RootMonitor.cxx "../../root/src/RootMonitor.cxx"
 \li @param _CollectionType This is used to specify what kind of collection we
 have
 */
...
public:
  ...
  //!Write
  /*!This is a pure virtual function which writes the data to a TFile called
   * @param file*/
  virtual void Write(TFile *file) = 0;

  //!Calculate
  /*!This is a pure virtual function which calculates the values for the
   * inherited classes for the current event number*/
